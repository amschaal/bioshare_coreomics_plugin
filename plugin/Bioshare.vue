...
export default {
  ...
  methods: {
    getShare () {
      var self = this
      this.$axios
        .get(`/api/bioshare/submission_shares/${self.submission.id}/`)
    ...
    setPermissions (action) {
      var self = this
      this.$axios.post(`/api/bioshare/submission_shares/${this.submission.id}/${action}/`, this.permissions)
        .then(function (response) {
    ...
    getPermissions () {
      var self = this
      this.$axios.get(`/api/bioshare/submission_shares/${this.submission.id}/permissions/`)
        .then(function (response) {
          self.permissions = response.data
        })
        .catch(function (error) {
